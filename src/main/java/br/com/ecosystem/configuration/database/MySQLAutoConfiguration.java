package br.com.ecosystem.configuration.database;
...
public class MySQLAutoConfiguration {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/ecosystemDb?useTimezone=true&serverTimezone=UTC");
        dataSource.setUsername("arthur");
        dataSource.setPassword("DBArootPassword");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("br.com.ecosystem.configuration.MySQLAutoConfiguration");
